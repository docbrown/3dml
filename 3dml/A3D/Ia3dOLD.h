...
HRESULT WINAPI A3dInitialize(void);              /* Initializes COM.  Should be called ONCE at the START of the app session. */
void WINAPI A3dUninitialize(void);            /* Uninitializes COM.  Should be called ONCE at the END of the app session. */
HRESULT WINAPI A3dRegister(void);             /* Sets all A3D registry keys.  A3D 2.0 will not work without them. */
HRESULT WINAPI A3dCreate(LPGUID  lpGUID,	        /* in,  Prefered Driver Guid, NULL ok */
                         ...
                         DWORD dwFeatures);       /* in, the features requested by the developer.*/
